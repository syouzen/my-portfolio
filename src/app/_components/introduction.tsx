  ...
  return (
    <div className="flex flex-col w-full items-center gap-y-6">
      ...
      <div id="introduction" className="mt-8 flex flex-col gap-y-4 text-sm text-gray-700 dark:text-gray-300">
        <h1 className="text-2xl font-bold mb-4 text-gray-700 dark:text-gray-200">소개</h1>
        ...
        <p>소통은 곧 신뢰를 의미합니다. 앞으로 새로운 조직에서도 활발한 소통을 통해 팀의 성과를 높이고 함께 성장할 수 있는 기회를 만들어가고 싶습니다.</p>
        <p>감사합니다!</p>
      </div>
    </div>
  );
